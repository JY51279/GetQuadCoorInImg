...
- 可通过按钮或 `F` 进入 Quad 聚焦模式；切换激活 Quad 或切换图片后会自动将目标及其周边区域居中，并自适应到约 75% 的视口范围。手动平移、缩放、重置图片位置或触发 `Z` 会退出该模式。
...
4. 在“Quad 标注”页选择标注项，可拖动当前 Quad 的顶点直接更新，也可拖动中心橙色手柄整体平移；还可使用“更新”“删除”或“新增”按钮。
